...
In addition, moderation actions (i.e., ban, timeout, delete, unban, untimeout) in one channel are automatically applied to all channels in the Shared Chat session.
