...
8. The `first-msg` flag is not populated on the mirrored messages.
...
10. Since this feature is complex and not widely tested yet, there may be bugs in Twitch's implementation.
