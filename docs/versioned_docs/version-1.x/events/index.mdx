...
import JavaDependency from '/src/components/JavaDependency';
...
<JavaDependency group="com.github.philippheuer.events4j" name="events4j-handler-reactor" version="0.9.8" scope="implementation" />
...
<JavaDependency group="com.github.philippheuer.events4j" name="events4j-handler-spring" version="0.9.8" scope="implementation" />
