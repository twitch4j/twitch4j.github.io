...
- [Following Events (Deprecated)](./topic-following-events)
- [Friendship Events (Deprecated)](./topic-friendship-events)
...
- [Presence Events (Deprecated)](./topic-presence-events)
